...
PAGE_KINDS = {
  "drops": "ui_state_snapshot",
  "ev": "dashboard_snapshot",
  "sidebar": "ui_state_snapshot",
}


@dataclass(frozen=True)
class FairOddsPageCapture:
  page: str
  url: str
  document_title: str
  body_text: str
...
def capture_fairodds_page(bundle: RunBundle, capture: FairOddsPageCapture) -> None:
  kind = PAGE_KINDS.get(capture.page)
  if kind is None:
    raise ValueError(f"Unsupported FairOdds page: {capture.page}")
