...
PAGE_KINDS = {
  "home": "dashboard_snapshot",
  "training": "training_page_snapshot",
  "tools": "tool_index_snapshot",
  "calculator": "calculator_snapshot",
  "offer_table": "offer_table_snapshot",
  "calendar": "calendar_snapshot",
  "settings": "settings_snapshot",
  "utility": "utility_page_snapshot",
}


@dataclass(frozen=True)
class ProfitMaximiserPageCapture:
  page: str
  url: str
  document_title: str
  body_text: str
...
def capture_profitmaximiser_page(
  bundle: RunBundle,
  capture: ProfitMaximiserPageCapture,
) -> None:
  kind = PAGE_KINDS.get(capture.page)
  if kind is None:
    raise ValueError(f"Unsupported ProfitMaximiser page: {capture.page}")
